...
%% obtaining luminane to luma mapping based on barten curve

%% constants        
    a = -1; b = -2.5840191E-2; c = 8.0242636E-2; d = -1.0320229E-1;
    e = 1; f =2.8745620E-2; g = -2.5468404E-2; h = -3.1978977E-3; 
    k = 1; m = 1.3635334E-3;
%% JND steps
    JND = [1:2^bitdepth-1];    
